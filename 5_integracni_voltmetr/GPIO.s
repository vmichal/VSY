...
GPIO_INIT    PROC
	...
	LDR R0, =GPIOA_MODER
	LDR R1, [R0]
	ldr r2, =(GPIO_MODER_MODER2 :OR: GPIO_MODER_MODER3 :OR: GPIO_MODER_MODER0 :OR: GPIO_MODER_MODER1)
	bic r1, r2
	ldr r2, =(GPIO_MODER_MODER2_1 :OR: GPIO_MODER_MODER3_1 :OR: GPIO_MODER_MODER0_1 :OR: GPIO_MODER_MODER1_1)
	orr r1, r2
	str r1, [r0]
